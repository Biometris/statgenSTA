...
|trLat | Latitude | Position in a map plot (see [**2.6**](#TDPlot)) |
|trLong | Longitude | Position in a map plot (see [**2.6**](#TDPlot)) |
|trPlWidth | Plot width | Ratio of width/height in a layout plot |
|trPlLength | Plot length | Ratio of width/height in a layout plot |
