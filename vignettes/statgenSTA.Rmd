...
optsTab$format <- factor(ifelse(optsTab$asDataFrame == 0, 2, 1), 
                         labels = c("data.frame", "list"))
optsTab <- optsTab[order(optsTab[["model"]]), c(1:3, 5)]
knitr::kable(optsTab, align = c("lllll"), row.names = FALSE)
```
